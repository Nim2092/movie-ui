    ...
    const feedbacks = [
        {
            ...
            userComments: [
                ...
                },
                {
                    ...
                    comment: 'Mình coi phim rạp trước giờ chưa từng khóc trong rạp như này',
                    rating: 8,
                },
                {
                    username: 'Le Thi Thuy Trang',
                    comment: 'Mình coi phim rạp Đáng xem',
                    rating: 8,
                },
            ],
        },
        ...
        <div className={cx('app')}>
            ...
            <div className={cx('video-panel')}>
                {feedbacks.map((feedback) => (
                    <div key={feedback.id} className={cx('video-card')} onClick={() => handleFeedbackClick(feedback)}>
                        ...
                        <div className={cx('video-details')}>
                            ...
                            <div className={cx('video-stats')}>
                                ...
                                <span className={cx('comments')}>{feedback.comments}</span>
                            </div>
                        </div>
                        <div className={cx('comments')}>
                            {feedback.userComments.map((comment, index) => (
                                <div key={`${feedback.id}-${index}`} className={cx('comment')}>
                                    ...
                                    <p className={cx('comment-text')}>{truncateComment(comment.comment)}</p>
